...
public class Stylist {
    ...
    static class Style {
        ...
        public static final String Font_TimeNewRoman_BOLDTALIC = "Font_TimeNewRoman_BOLDTALIC";

        public static final String Text_CUSTOMBOLD1 = "Text_CUSTOMBOLD1";
        public static final String Text_CUSTOMBOLD2 = "Text_CUSTOMBOLD2";
        public static final String Text_CUSTOMBOLD3 = "Text_CUSTOMBOLD3";
    ...
    static class Preset {
        ...
        public static final String BoldText01_TimeNewRoman_VerticalCenter_NoBorder = "BoldText01_TimeNewRoman_VerticalCenter_NoBorder";
